...
var userController = {
    createUser: function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var _a, day, month, year, user, createdUser, error_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 2, , 3]);
                    _a = req.body.data_nascimento.split("/"), day = _a[0], month = _a[1], year = _a[2];
                    user = {
                        nome: req.body.nome,
                        cpf: req.body.cpf,
    ...
    listAllUsers: function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var users;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, userService_1.default.listAllUsers()];
                case 1:
                    users = _a.sent();
